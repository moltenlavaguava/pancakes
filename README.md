...
This project was made for a final at the University of Utah. It was designed with the goal of helping students more easily install Python to work on what actually matters. pancakes is hosted here on GitHub to allow anyone to add to it if this project is somehow used more.

If you ever want to collaborate on this project, just message me (moltenlavaguava, Jacob) and I can add you to the contributor list. Otherwise, standard pull requests are welcome as well. Thanks!

Anyway, here's the bee movie script:
